...
export class AliExpressDiscoveryEngine {
  ...
  private getFallbackProducts(keyword: string, limit: number): AliExpressProduct[] {
    const pool: Record<string, AliExpressProduct[]> = {
      blender: [
        { title: 'Portable USB Blender 380ml', price: 12.50, currency: 'USD', orders: 8500, rating: 4.6, image_url: null, supplier: 'HomeGadgets Store', shipping_cost: 2.50, shipping_days: 12, product_url: 'https://www.aliexpress.com' },
        { title: 'Mini Rechargeable Juice Blender', price: 14.80, currency: 'USD', orders: 5200, rating: 4.4, image_url: null, supplier: 'KitchenPro Official', shipping_cost: 3.00, shipping_days: 15, product_url: 'https://www.aliexpress.com' },
      ],
      projector: [
        { title: 'Galaxy Star Projector LED', price: 18.90, currency: 'USD', orders: 12000, rating: 4.5, image_url: null, supplier: 'LightMagic Store', shipping_cost: 2.00, shipping_days: 14, product_url: 'https://www.aliexpress.com' },
      ],
      printer: [
        { title: 'Mini Thermal BT Printer', price: 16.50, currency: 'USD', orders: 6800, rating: 4.3, image_url: null, supplier: 'TechMini Official', shipping_cost: 3.50, shipping_days: 10, product_url: 'https://www.aliexpress.com' },
      ],
      massage: [
        { title: 'Deep Tissue Massage Gun', price: 28.00, currency: 'USD', orders: 15000, rating: 4.7, image_url: null, supplier: 'FitGear Pro', shipping_cost: 5.00, shipping_days: 12, product_url: 'https://www.aliexpress.com' },
      ],
      vacuum: [
        { title: 'Wireless Car Vacuum 6000Pa', price: 15.90, currency: 'USD', orders: 4500, rating: 4.2, image_url: null, supplier: 'AutoClean Store', shipping_cost: 3.00, shipping_days: 15, product_url: 'https://www.aliexpress.com' },
      ],
    };
